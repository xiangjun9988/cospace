                ...
                <a href="javascript:;" :class="{'active': !ischeckbox && activedata.indexOf(item.id) !==-1}">
                    ...
                    <div class="radio">
                        <label class="no-padding-left">
                            ...
                            <input name="department" type="checkbox" class="colored-blue" v-if="ischeckbox" @click="handleCallback($event,item)" :checked="activeid.indexOf(item.id) != -1">
...
export default {
    ...
    methods: {
        ...
        handleCallback(e,item){
            this.vm.$emit('handleCallback2', item);
            e.stopPropagation();
        }
    }
}
