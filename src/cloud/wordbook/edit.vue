...
export default{
    ...
    created: function(){
        ...
        $.get(window.config.api + "/dictType/findInfoById.do?token="+token,{dictCode:this.$route.params.id})
        .then(data=>{
            if(!data.success){
                //返回错误状态                    
                return false;
            }
            this.wordBookData = data.obj;
            //console.log(JSON.stringify(data))
            //console.log(JSON.stringify(this.wordBookData))
